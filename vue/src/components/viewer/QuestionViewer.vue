        ...
        <div class="mt-3">
            <div v-if="question.type === 'select'">
                <select
                    ...
                    :value="modelValue" @change="emits('update:modelValue', $event.target.value)">
            ...
            <div v-else-if="question.type === 'radio'">
                <div v-for="(option, ind) of question.data.options" :key="option.uuid" class="flex items-center">
                    <input @change="emits('update:modelValue',$event.target.value)" :name="'question'+question.id"
                           :value="option.text" :id="option.uuid" type="radio"
