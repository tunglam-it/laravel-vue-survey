<template>
    ...
    <form class="mt-8 space-y-6" @submit="login" method="post">
        <div v-if="errMsg" class="flex items-center justify-between py-3 px-5 bg-red-500 text-white rounded">
            {{ errMsg }}
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <input id="remember-me" name="remember" type="checkbox" v-model="user.remember"
