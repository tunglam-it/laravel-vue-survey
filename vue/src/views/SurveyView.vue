    ...
    <PageComponent>
        <template v-slot:header>
            <div class="flex justify-between items-center">
                ...
                <button @click="deleteSurvey()" type="button" v-if="route.params.id"
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea name="description" id="description" rows="3" autocomplete="survey_description"
                                      v-model="model.description" placeholder="Describe your survey"
                                      class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md block w-full mt-1"></textarea>
                        </div>
                    </div>
                    <!--Description end-->
                    <!--Expire Date start-->
                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div v-for="(question,index) in model.question" :key="question.id">
                        <QuestionEditor :question="question" :index="index" @change="questionChange"
                                        @addQuestion="addQuestion" @deleteQuestion="deleteQuestion"></QuestionEditor>
                    </div>
                </div>
                <!--Add Question end-->
                <!--Button save start-->
...
function onImageChoose(ev) {
    ...
    reader.onload = () => {
        //the field sent on backend and apply valid
