...
Route::get('/survey-by-slug/{survey:slug}',[Controllers\SurveyController::class,'showForGuest'])->name('showForGuest');
Route::post('survey/{survey}/answer',[Controllers\SurveyController::class,'storeAnswer']);
